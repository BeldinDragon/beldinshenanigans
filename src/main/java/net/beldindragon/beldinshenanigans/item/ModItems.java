...
import net.beldindragon.beldinshenanigans.item.custom.ChiselItem;
...
public class ModItems {
    public static final DeferredRegister.Items ITEMS = DeferredRegister.createItems(Shenanigans.MOD_ID);
